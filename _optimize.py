...
class SpatialGridIndex:
    ...
    def _insert_internal(self, item_id: Any, bbox: Tuple[float, float, float, float]) -> None:
    ...
    def insert(self, item_id: Any, bbox: Tuple[float, float, float, float]) -> None:
        ...
        with _LOCK:
            self._insert_internal(item_id, bbox)
    ...
    def _update_internal(self, item_id: Any, new_bbox: Tuple[float, float, float, float]) -> None:
        ...
        self._remove_internal(item_id)
        self._insert_internal(item_id, new_bbox)
    ...
    def update(self, item_id: Any, new_bbox: Tuple[float, float, float, float]) -> None:
        ...
        """
        with _LOCK:
            self._update_internal(item_id, new_bbox)
